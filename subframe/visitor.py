...
class SubstraitPlanVisitor:
    ...
    def visit_subquery_scalar(
        self, subquery: algebra_pb2.Expression.Subquery.Scalar
    ) -> Any:
        """Visits a scalar subquery."""
        if subquery.HasField("input"):
            self.visit_relation(subquery.input)

    def visit_subquery_in_predicate(
        self, subquery: algebra_pb2.Expression.Subquery.InPredicate
    ) -> Any:
        """Visits an in predicate."""
        if subquery.HasField("haystack"):
            self.visit_relation(subquery.haystack)

    def visit_subquery_set_predicate(
        self, subquery: algebra_pb2.Expression.Subquery.SetPredicate
    ) -> Any:
    ...
    def visit_subquery_set_comparison(
        self, subquery: algebra_pb2.Expression.Subquery.SetComparison
    ) -> Any:
    ...
    def visit_nested_struct(
        self, structure: algebra_pb2.Expression.Nested.Struct
    ) -> Any:
        """Visits a nested struct."""
        for field in structure.fields:
            self.visit_expression(field)

    def visit_nested_list(
        self, list_literal: algebra_pb2.Expression.Nested.List
    ) -> Any:
    ...
    def visit_nested_key_value(
        self, key_value: algebra_pb2.Expression.Nested.Map.KeyValue
    ) -> Any:
    ...
    def visit_struct_item(
        self, item: algebra_pb2.Expression.MaskExpression.StructItem
    ) -> Any:
    ...
    def visit_reference_segment_map_key(
        self, map_key: algebra_pb2.Expression.ReferenceSegment.MapKey
    ) -> Any:
        """Visits a map key."""
    ...
    def visit_reference_segment_struct_field(
        self, field: algebra_pb2.Expression.ReferenceSegment.StructField
    ) -> Any:
    ...
    def visit_reference_segment_list_element(
        self, element: algebra_pb2.Expression.ReferenceSegment.ListElement
    ) -> Any:
    ...
    def visit_map_key_value(
        self, key_value: algebra_pb2.Expression.Literal.Map.KeyValue
    ) -> Any:
    ...
    def visit_user_defined(
        self, user_defined: algebra_pb2.Expression.Literal.UserDefined
    ) -> Any:
    ...
    def visit_if_value(
        self, if_value: algebra_pb2.Expression.SwitchExpression.IfValue
    ) -> Any:
        """Visits an if value."""
    ...
    def visit_scalar_function(
        self, function: algebra_pb2.Expression.ScalarFunction
    ) -> Any:
    ...
    def visit_window_function(
        self, function: algebra_pb2.Expression.WindowFunction
    ) -> Any:
    ...
    def visit_window_rel_function(
        self, function: algebra_pb2.ConsistentPartitionWindowRel.WindowRelFunction
    ) -> Any:
    ...
    def visit_switch_expression(
        self, expression: algebra_pb2.Expression.SwitchExpression
    ) -> Any:
    ...
    def visit_singular_or_list(
        self, singular_or_list: algebra_pb2.Expression.SingularOrList
    ) -> Any:
    ...
    def visit_multi_or_list(
        self, multi_or_list: algebra_pb2.Expression.MultiOrList
    ) -> Any:
    ...
    def visit_struct_select(
        self, structure: algebra_pb2.Expression.MaskExpression.StructSelect
    ) -> Any:
        """Visits a struct select."""
        for item in structure.struct_items:
            self.visit_struct_item(item)

    def visit_list_select(
        self, select: algebra_pb2.Expression.MaskExpression.ListSelect
    ) -> Any:
    ...
    def visit_list_select_item(
        self, _: algebra_pb2.Expression.MaskExpression.ListSelect.ListSelectItem
    ) -> Any:
        """Visits a list select item."""
        return None

    def visit_map_select(
        self, select: algebra_pb2.Expression.MaskExpression.MapSelect
    ) -> Any:
        """Visits a map select."""
        if select.HasField("child"):
            self.visit_select(select.child)
        match select.WhichOneof("select"):
            ...
            case _:
                raise ValueError(
                    f'Unexpected select case: {select.WhichOneof("select")}'
                )

    def visit_expression_literal_struct(
        self, struct: algebra_pb2.Expression.Literal.Struct
    ) -> Any:
    ...
    def visit_reference_segment(
        self, segment: algebra_pb2.Expression.ReferenceSegment
    ) -> Any:
    ...
    def visit_mask_expression(
        self, expression: algebra_pb2.Expression.MaskExpression
    ) -> Any:
    ...
    def visit_expand_field(self, field: algebra_pb2.ExpandRel.ExpandField) -> Any:
        ...
        match field.WhichOneof("field_type"):
            ...
            case _:
                raise ValueError(
                    f'Unexpected expand field type: {field.WhichOneof("field_type")}'
                )
    ...
    def visit_extension_single_relation(
        self, rel: algebra_pb2.ExtensionSingleRel
    ) -> Any:
    ...
    def visit_nested_loop_join_relation(
        self, rel: algebra_pb2.NestedLoopJoinRel
    ) -> Any:
    ...
    def visit_window_relation(
        self, rel: algebra_pb2.ConsistentPartitionWindowRel
    ) -> Any:
