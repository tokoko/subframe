...
class SubstraitTypeListener(ParseTreeListener):
    ...
    def enterPrecisionTimestamp(
        self, ctx: SubstraitTypeParser.PrecisionTimestampContext
    ):
        pass

    # Exit a parse tree produced by SubstraitTypeParser#precisionTimestamp.
    def exitPrecisionTimestamp(
        self, ctx: SubstraitTypeParser.PrecisionTimestampContext
    ):
        pass
    ...
    def enterNumericParameterName(
        self, ctx: SubstraitTypeParser.NumericParameterNameContext
    ):
        pass

    # Exit a parse tree produced by SubstraitTypeParser#numericParameterName.
    def exitNumericParameterName(
        self, ctx: SubstraitTypeParser.NumericParameterNameContext
    ):
        pass
    ...
    def enterMultilineDefinition(
        self, ctx: SubstraitTypeParser.MultilineDefinitionContext
    ):
        pass

    # Exit a parse tree produced by SubstraitTypeParser#MultilineDefinition.
    def exitMultilineDefinition(
        self, ctx: SubstraitTypeParser.MultilineDefinitionContext
    ):
        pass
